import { Crosshair, Star, StarOff, PenSquare } from 'lucide-react';
        ...
        <dl className="mt-4 grid grid-cols-2 gap-4">
          ...
          {gun.action && (
            <div>
              ...
              <dd className="mt-1 text-sm text-gray-900">{gun.action}</dd>
            </div>
          )}
          {gun.choke && (
            <div>
              <dt className="text-sm font-medium text-gray-500">Choke</dt>
              <dd className="mt-1 text-sm text-gray-900">{gun.choke}</dd>
            </div>
          )}
        </dl>
